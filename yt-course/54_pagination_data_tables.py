...
class MainApp(MDApp):
    ...
    def build(self):
        ...
        table = MDDataTable(
            ...
            use_pagination = True,
            rows_num = 3,
            pagination_menu_height = '240dp',# Set more than 3 rows
            pagination_menu_pos = "auto", # Set a pagination menu
            ...
            row_data = [
                ...
                ("Mar", "Will", "mw@com.com", "(123)321321"),
                ("Jack", "Spe", "js@com.com", "(123)321321"),
                ("John", "Elder", "je@com.com", "(123)321321"),
                ("Dan", "Miel", "dm@com.com", "(123)321321"),
                ("Mar", "Will", "mw@com.com", "(123)321321"),
                ("Jack", "Spe", "js@com.com", "(123)321321"),
